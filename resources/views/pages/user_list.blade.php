...
@section("page_header")
                ...
                <table class="table no-margin" id="example1">
                    ...
                    @foreach ($datas as $data)
                        <tr>
                            <td>{{ $data->name }}</td>
                            <td>{{ $data->email }}</td>
                            <td>@if ($data->is_block == 0)
                                    <span id="{{$data->id}}" class="label label-success">UnBlock</span>
                                @else
                                    <span id="{{$data->id}}" class="label label-danger">Block</span>
                                @endif</td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        {{--</li>--}}
                                        <li><a   href={{ url('/user/'.$data->id).'/edit' }}>Edit</a></li>
    ...
    <!-- /.box-body -->
        <div class="box-footer clearfix">
            ...
            <a href="{{url('/user/create')}}" class="btn btn-sm btn-info btn-flat pull-left">Add New User</a>
